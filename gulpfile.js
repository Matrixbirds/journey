/*global -$ */
'use strict';
// generated on 2016-06-29 using generator-modern-frontend 0.2.9
var fs = require('fs');
...
gulp.task('serve', ['stylesheet', 'javascript', 'fonts', 'media'], function () {
  ...
  gulp.watch(['app/css/**/*.css', '!app/css/sprites/*.css'], ['stylesheet']);
...
gulp.task('build', ['html', 'images', 'fonts', 'extras', 'media'], function () {
